...
The design repository owns UI, UX and app assets. Platform implementations follow the same interaction contracts while adapting to their device’s input and playback capabilities.

Repositories are currently private while development continues.
